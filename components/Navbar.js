...
<nav className="flex items-center justify-between flex-wrap bg-teal-500 p-6">
  <div className="flex items-center flex-shrink-0 text-white mr-6">
    ...
    <span className="font-semibold text-xl tracking-tight">MKT</span>
  </div>
  <div className="block lg:hidden">
    <button
    onClick={handleMenu}
    id='boton' className="flex items-center px-3 py-2 border rounded text-teal-200 border-teal-400 hover:text-white hover:border-white">
  ...
  <div className="bg-red">cwvwevwevevewve</div>
